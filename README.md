...
A privacy-first real-time chat application designed around temporary conversations and minimal data persistence.

No accounts. No stored conversations. No message history.
...
A lightweight grocery tracker with quantity and price calculations, powered entirely by local storage.
...
A classic game supporting both voice commands and traditional keyboard input.
